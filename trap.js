...
document.getElementById('trap-button').addEventListener('click', trapMultiplication)
...
function trapMultiplication () {
  trapA = document.getElementById('trap-a').value

  trapB = document.getElementById('trap-b').value

  trapH = document.getElementById('trap-h').value
  ...
  document.getElementById('trap-answer').innerHTML = trapAnswer
}
